...
#include "common_christos/macros.h"
...
int adm_sum_cube_s_dump_blocks(const float *x, int w, int h, int px_stride, int blk_x, int blk_y, int new_cols, int new_rows, int left, int right, int top, int bottom, int p_o, int Nlines_x, int Nlines_y, float accum_blocks_row[new_rows*new_cols], int left_over_x, int left_over_y);
