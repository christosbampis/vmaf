...
int vif_sum_s_blk(const float *x, int w, int h, int stride, int blk_x, int blk_y, int new_cols, int new_rows, float num_scale_blocks_row[new_rows*new_cols], int Nlines_x, int Nlines_y, int p_o, int left_over_x, int left_over_y);
